package com.example.test;// Java program to demonstrate read and write of image
            ...
            throws IOException
    {
        ...
        try {
            File input_file = new File(
                    "E:\\WORK\\tutorial\\QRCodeExample\\src\\main\\logo\\logo.png");
        ...
        try {
            ...
            File output_file = new File(
                    "E:\\WORK\\tutorial\\QRCodeExample\\src\\main\\logo\\logo1.png");
